...
![list of linked files](../.gitbook/assets/entryeditor-linkedfiles%20%282%29%20%283%29%20%281%29.png)
...
1. Options → Preferences → File → External file links → Main file directory
   ...
   ![Main file directory](../.gitbook/assets/preferences-file-mainfiledirectory%20%282%29%20%283%29%20%282%29.png)

2. File → Library properties → General file directory.
3. File → Library properties → User-specific file directory

   ![Override default file directories](../.gitbook/assets/libraryproperties-overridedefaultfiledirectories%20%282%29%20%283%29%20%282%29.png)
...
![auto link file](../.gitbook/assets/entryeditor-autolinkfile%20%282%29%20%283%29%20%282%29.png)
...
![Download from URL](../.gitbook/assets/entryeditor-general-downloadfilefromurl%20%282%29%20%283%29%20%281%29.png)
...
![Use regular expression search](../.gitbook/assets/preferences-file-useregularexpressionsearch%20%282%29%20%283%29%20%282%29.png)
...
![Manage external file types](../.gitbook/assets/manageexternalfiletypes%20%282%29%20%281%29%20%284%29%20%281%29.png)

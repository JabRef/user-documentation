...
1. Go to **Lookup → Search for unlinked local files** \(or press `SHIFT + F7`\)
   ...
   ![FindUnlinkedFiles - Menu](../.gitbook/assets/findunlinkedfiles-menu-5.2%20%282%29%20%282%29%20%282%29%20%282%29%20%282%29%20%282%29.png)

2. The _Find unlinked files_ dialog opens.

   ![FindUnlinkedFiles - Initial dialog](../.gitbook/assets/findunlinkedfiles-window-5.2%20%282%29%20%282%29%20%282%29%20%282%29%20%282%29%20%282%29.png)
...
5. The files not yet contained in the database are shown.
   ...
   ![FindUnlinkedFiles - Found files](../.gitbook/assets/findunlinkedfiles-foundfiles-5.2%20%282%29%20%282%29%20%282%29%20%282%29%20%282%29%20%281%29.png)

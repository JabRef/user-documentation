...
*   Select your preferred language, login, and click on _JabRef\_en.properties_
    ...
    <img src="../.gitbook/assets/crowdin-select-file (1).png" alt="Screenshot of Crowdin select file page" data-size="original">
*   Choose the string you want to translate in the left panel (strings to be translated are listed first)
    ...
    <img src="../.gitbook/assets/crowdin-translate (1).png" alt="Screenshot of Crowdin translation page" data-size="original">
...
![Screenshot of Crowdin download dialog](<../.gitbook/assets/crowdin-download-translation (1).png>)

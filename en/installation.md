...
- JabRef 5.6 requires macOS 10.14 or higher.
- JabRef 5.12 (current dev version) requires macOS 11 or later
- JabRef 5.12 (current dev version) requires on GTK 3.8 or later on Linux

...
![Screenshot of the search bar](../.gitbook/assets/search-bar-v5.2%20%282%29%20%281%29%20%281%29.png)
...
| `key` | Search for citation keys | `bibtexkey == miller2005`: search for an entry whose citation key is **miller2005** |

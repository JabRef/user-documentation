...
1. **File → Preferences → Linked files**, item _Main file directory._
    ...
    <img src="../.gitbook/assets/preferences-linkedfiles-5.2 (1).png" alt="Main file directory" data-size="original">
...
![Search and store files relative to library file location](<../.gitbook/assets/preferences-file-searchandstoreforfilesrelativetolibraryfilelocation (1).png>).
...
![Linked Files Preferences](<../.gitbook/assets/preferences-linkedfiles-5.2 (1).png>)
...
![Download from URL](<../.gitbook/assets/entryeditor-general-downloadfilefromurl (1).png>)
...
![The linked files preferences](<../.gitbook/assets/preferences-linkedfiles-5.2 (1).png>)

...
The results are displayed in the [import inspection window](../../import-export/import/importinspectiondialog.md). In case an error occurs, it is shown in a popup.

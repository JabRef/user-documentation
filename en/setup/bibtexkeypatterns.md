...
1. Open the preferences  
   ...
   ![Options Preferences](../.gitbook/assets/optionspreferences%20%282%29%20%281%29%20%282%29.png)
...
5. Change the default pattern to `[authors]:[camel]`.  
   ...
   ![BibTeX key generator preferences - authors camel](../.gitbook/assets/preferences-bibtex-key-generator-authors-camel%20%282%29%20%283%29.png)

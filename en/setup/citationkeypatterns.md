...
2. From the "Library" menu, open the "Citation key pattern" setting
    ...
    <img src="../.gitbook/assets/library-citation-key-patterns.png" alt="Library Citation key patterns" data-size="original">
3. Set the pattern for the desired entry types, and press the apply button.

    <img src="../.gitbook/assets/citation-key-patterns.png" alt="Citation key patterns" data-size="original">

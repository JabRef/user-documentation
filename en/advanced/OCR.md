...
* You can select one or multiple languages for OCR text recognition using the **OCR languages** dropdown menu.

    ![OCR language selection](../.gitbook/assets/ocr-language-selection.png)
